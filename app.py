...
# 1. Clonar tu yolov5 - https://github.com/ultralytics/yolov5
pathLocla = 'C:/Users/Predator/Documents/Desarrollo_flask/vision_artificial/yolov5' # ruta de la clonación de yolov5
model = torch.hub.load(pathLocla, 'custom', path='firemodel.pt', source='local') # cargas el modelo producto del entrenamiento
model.eval()
